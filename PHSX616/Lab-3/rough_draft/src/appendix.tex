...
We preform several standard statistical assessments of our data, necessary for chi-square testing. \textit{note: information related to detector uncertainty is not yet available at the time of writing.} Goodness of fit (chi-square) parameters can be found in table \ref{tab:}. 
